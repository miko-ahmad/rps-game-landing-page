    ...
    <div className=" bg-white px-10 py-20 rounded-3xl border-2">
      ...
      <div className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-y-4">
          ...
          {/* <button className="flex border-2 border-gray-100  py-3 rounded-xl justify-center items-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
